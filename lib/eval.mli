...
val add_fresh_value : val_env -> Value.value -> (val_env * string)

val ptr_binary : val_env -> Value.value -> string -> string -> Value.value

val ptr_unary : val_env -> Value.value -> string -> Value.value
